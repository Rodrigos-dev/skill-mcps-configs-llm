...
description: Gerencia sessões do opencode - criar, listar, retomar, finalizar e logar erros/acertos
---

## O que eu faço

Gerencio o ciclo de vida completo das sessões do opencode, mantendo um histórico persistente com contexto.

## Estrutura de Armazenamento

```
C:\Users\Acer\.config\opencode\sessions\
├── session-001.json
├── session-002.json
└── ...
```
...
{
  "type": "success",
  "message": "Componentecriado com sucesso: user-card",
