...
description: Gerencia sessões do Continue - criar, listar, retomar, finalizar e logar erros/acertos
---

## O que eu faço

Gerencio o ciclo de vida completo das sessões do Continue, mantendo um histórico persistente com contexto.

## Estrutura de Armazenamento

```
C:\Users\Acer\.continue\sessions\
├── session-001.json
├── session-002.json
└── ...
```
