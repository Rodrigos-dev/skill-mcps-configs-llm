...
1. Ler `C:\Users\Acer\.continue\config.yaml`
2. Ler `C:\Users\Acer\.continue\memory\MEMORY.md`
3. **Criar nova sessão** (usando session-manager)
4. **Ler últimas 3 sessões** para contexto
5. Verificar se existe tarefa SDD ativa em `.continue/.tasks/`
...
1. Listar arquivos `session-*.json` em `C:\Users\Acer\.continue\sessions\`
...
3. Criar arquivo `session-XXX.json` com:
   ...
   ```
4. Salvar em `C:\Users\Acer\.continue\sessions\session-XXX.json`
