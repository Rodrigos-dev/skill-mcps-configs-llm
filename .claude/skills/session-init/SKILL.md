...
1. Ler `C:\Users\Acer\.claude\CLAUDE.md`
2. Ler `C:\Users\Acer\.claude\memory\MEMORY.md`
3. **Criar nova sessão** (usando session-manager)
4. **Ler últimas 3 sessões** para contexto
5. Verificar se existe tarefa SDD ativa em `.claude/.tasks/`
...
1. Listar arquivos `session-*.json` em `C:\Users\Acer\.claude\sessions\`
...
3. Criar arquivo `session-XXX.json` com:
   ...
   ```
4. Salvar em `C:\Users\Acer\.claude\sessions\session-XXX.json`
