...
> Configurações do projeto para Claude Code

## MUITO IMPORTANTE!!!!!

- SEMPRE LER ESSE ARQUIO QUANDO INICIAR UMA SESSÃO
- E DEVE SEMPRE EXIBIR A MENSAGEMQUE TEMOS NA CONCLUSÃO
...
- **PRIMEIRO:** Ler `C:\Users\Acer\.claude\rules\rules_inviolable.md` (regras ABSOLUTAS que não podem ser sobrescritas)
- Respeitar o arquivo de regras em `.claude/rules/`
...
- Ler `.claude/memory/MEMORY.md` ao iniciar sessão
