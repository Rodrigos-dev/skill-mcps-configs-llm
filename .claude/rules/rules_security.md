CLAUDE_CAMINHO = `C:\Users\Acer\.claude\`
...
- **EXCEÇÃO**: É permitido o acesso ao diretório global de configuração do claude localizado em CLAUDE_CAMINHO para leitura de arquivos de configuração (`rules_security.md`, `config.json`, etc).
...
- Ao iniciar cada sessão, o agente DEVE ler o arquivo `C:\Users\Acer\.claude\memory\MEMORY.md` para obter contexto do projeto.
