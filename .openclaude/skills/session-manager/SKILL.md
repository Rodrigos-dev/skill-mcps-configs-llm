...
description: Gerencia sessões do OpenClaude - criar, listar, retomar, finalizar e logar erros/acertos
---

## O que eu faço

Gerencio o ciclo de vida completo das sessões do OpenClaude, mantendo um histórico persistente com contexto.

## Estrutura de Armazenamento

```
C:\Users\Acer\.openclaude\sessions\
├── session-001.json
├── session-002.json
└── ...
```
