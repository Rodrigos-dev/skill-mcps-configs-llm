...
1. Ler `C:\Users\Acer\.gemini\GEMINI.md`
2. Ler `C:\Users\Acer\.gemini\.rules\rules_inviolable.md`
3. **Criar nova sessão** (usando session-manager)
4. **Ler últimas 3 sessões** para contexto
5. Verificar se existe tarefa SDD ativa em `.gemini/.tasks/`
...
1. Listar arquivos `session-*.json` em `C:\Users\Acer\.gemini\sessions\`
